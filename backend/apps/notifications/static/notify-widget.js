...
(function() {
    ...
    function initQStackNotification() {
        ...
        const serverUrl = currentScript.getAttribute('data-server') || 'http://localhost:8002';
        ...
        socket.on('notification', (data) => {
            ...
            if (recipient && payload.recipient && payload.recipient !== recipient && payload.recipient !== 'all') {
                console.log('[QStack] Live notification filtered out (not for this recipient).');
                return;
            }
